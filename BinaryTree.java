...
public class BinaryTree<NodeData> {
	 ...
	 */
	public BinaryTree(NodeData data) {
	 ...
	 */
	public BinaryTree(NodeData data, BinaryTree<NodeData> left, BinaryTree<NodeData> right) {
	...
	public BinaryTree<NodeData> getLeft() {
		return left;
	}

	public BinaryTree<NodeData> getRight() {
		return right;
	}
	 ...
	 */
	public boolean equalsTree(BinaryTree<NodeData> t2) {
	 ...
	 */
	public ArrayList<NodeData> fringe() {
	 ...
	 */
	public void addToFringe(ArrayList<NodeData> fringe) {
		if (isLeaf()) {
			fringe.add(data);
		}
		else {
